...
const Main = () => {
    ...
    return (
        <div id="main">
           <img className="w-full h-screen object-cover" src="personal-portfolio/src/assets/samuele-errico-piccarini-FMbWFDiVRPs-unsplash.jpg" alt="" />
        <div className="w-full h-screen absolute top-0 left-0 bg-white/0">  
            ...
            <div className="max-w-[600px] m-auto h-full w-full flex flex-col content-start pt-12">
